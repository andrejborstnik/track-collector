...
<script type="text/babel">
    ...
    const resetPassword = function () {
        ...
        if (validateEmail(email)) {
            let resetPasswordData = {"email": email};
            request({
                method: "POST",
    ...
    const resetPasswordStep2 = function () {
        let pass1 = this.newPassword1;
        let pass2 = this.newPassword2;

        if (pass1 == pass2 && pass1.length > 5) {
            let resetPasswordData = {"password": pass1, "resetToken": this.resetToken}
            request({
                method: "POST",
                uri: `${config.paths_api_prefix}/resetPassword`,
                json: resetPasswordData
    ...
    export default {
        ...
        computed: {
            ...
            hasToken: function () {
                return typeof this.resetToken != 'undefined';
            },
            ...
            passwordTooShort: function () {
                return this.newPassword1.length <= 5;
            }
        }
